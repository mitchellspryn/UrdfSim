...
public: //types
    ...
    struct DistanceSetting : SensorSetting {
        ...
        float uncorrelated_noise_sigma = 0.002f * 100;
...
private:
    ...
    static void initializeDistanceSetting(DistanceSetting& distance_setting, const Settings& settings_json)
    {
        ...
        distance_setting.ignore_pawn_collision = settings_json.getBool("IgnorePawnCollision", distance_setting.ignore_pawn_collision);
        ...
        distance_setting.uncorrelated_noise_sigma = settings_json.getFloat("UncorrelatedNoiseSigma", distance_setting.uncorrelated_noise_sigma);
    ...
    static void initializeLidarSetting(LidarSetting& lidar_setting, const Settings& settings_json)
    {
        ...
        lidar_setting.ignore_pawn_collision = settings_json.getBool("IgnorePawnCollision", lidar_setting.ignore_pawn_collision);
