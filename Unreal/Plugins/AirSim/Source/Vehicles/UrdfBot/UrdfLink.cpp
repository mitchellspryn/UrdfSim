...
const msr::airlib::Kinematics::State& AUrdfLink::GetKinematics() const
{
...
void AUrdfLink::SetReferenceFrameLocation(FVector &translation, FRotator &rotation)
{
...
FVector AUrdfLink::WorldFromReferenceOffset(FVector referenceOffset, bool inputInMeters)
{
    ...
    float scale = (inputInMeters ? UAirBlueprintLib::GetWorldToMetersScale(this) : 1.0f);
...
void AUrdfLink::UpdateKinematics(float dt)
{
    ...
    kinematics_.twist.linear = msr::airlib::Vector3r(this->RootComponent->ComponentVelocity.X, this->RootComponent->ComponentVelocity.Y, this->RootComponent->ComponentVelocity.Z);
...
msr::airlib::Pose AUrdfLink::GetPose()
{
...
void AUrdfLink::InitPostSetMesh()
{
    ...
    this->kinematics_.twist.linear = msr::airlib::Vector3r::Zero();
    this->kinematics_.twist.angular = msr::airlib::Vector3r::Zero();
    this->kinematics_.accelerations.linear = msr::airlib::Vector3r::Zero();
    this->kinematics_.accelerations.angular = msr::airlib::Vector3r::Zero();
