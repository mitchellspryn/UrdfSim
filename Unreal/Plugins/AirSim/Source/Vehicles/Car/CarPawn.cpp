...
USceneComponent* ACarPawn::GetComponent(FString componentName)
{
    // Debugging
...
void ACarPawn::GetComponentReferenceTransform(FString componentName, FVector& translation, FRotator& rotation)
{
    // Debugging
    if (componentName.Len() > 0)
    {
